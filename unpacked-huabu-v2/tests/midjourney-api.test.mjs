...
test("cache-busts the updated canvas assets", () => {
  ...
  assert.match(html, /ai2-agent-loop\.js\?v=agent-loop-v4-plan-order/);
  assert.match(html, /ai2-agent-panel\.js\?v=agent-v9-rh-safe-loop/);
  assert.match(html, /ai2-agent-panel\.css\?v=agent-v9-rh-safe-loop/);
