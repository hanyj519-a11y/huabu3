...
test("cache-busts the updated canvas assets", () => {
  ...
  assert.match(html, /ai2-agent-loop\.js\?v=agent-loop-v6-target-ref/);
  assert.match(html, /ai2-agent-panel\.js\?v=agent-v11-target-ref/);
  assert.match(html, /ai2-agent-panel\.css\?v=agent-v11-target-ref/);
