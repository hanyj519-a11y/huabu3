...
test("cache-busts the updated canvas assets", () => {
  ...
  assert.match(html, /ai2-agent-loop\.js\?v=agent-loop-v3-safe/);
  assert.match(html, /ai2-agent-panel\.js\?v=agent-v8-rh-safe-loop/);
  assert.match(html, /ai2-agent-panel\.css\?v=agent-v8-rh-safe-loop/);
