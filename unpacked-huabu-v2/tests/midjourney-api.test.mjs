...
test("cache-busts the updated canvas assets", () => {
  ...
  assert.match(html, /ai2-agent-loop\.js\?v=agent-loop-v2/);
  assert.match(html, /ai2-agent-panel\.js\?v=agent-v7-rh/);
  assert.match(html, /ai2-agent-panel\.css\?v=agent-v7-rh/);
