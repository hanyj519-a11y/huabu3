              ...
              m.jsxs("div", {
                ...
                children: [
                  ...
                  m.jsxs("div", {
                    ...
                    children: [
                      m.jsx("span", { children: "模型" }),
                      m.jsx("select", {
                        className: "text-model-select nodrag nopan",
                        value: d,
                        onChange: (f) => t.updateNode?.(e, { model: f.target.value, _modelPinned: !0 }),
                        children: (u.length ? u : [""]).map((f) =>
                          m.jsx("option", { value: f, children: f || "请先添加文本模型" }, f || "empty-text-model"),
                        ),
                      }),
                    ],
                  }),
      ...
      xp
        ? m.jsxs("div", {
            ...
            children: [
              ...
              m.jsxs("select", {
                className: "rh-node-input nodrag nopan",
                value: t.rhWorkflowRef || "",
                onChange: (f) => t.updateNode?.(e, { rhWorkflowRef: f.target.value }),
                children: [
                  m.jsx("option", {
                    value: "",
                    children: rhList.length ? "请选择工作流" : "尚未配置，请先到 API 设置添加",
                  }),
                  rhList.map((f) =>
                    m.jsx("option", { value: f.id, children: f.name || `工作流 ${f.workflowId}` }, f.id),
                  ),
                ],
              }),
              m.jsxs("div", {
                ...
                children: [
                  m.jsxs("button", {
                    ...
                    title: rhCur ? rhCur.note || "RunningHub 工作流" : "RunningHub 工作流",
                    children: [
                      m.jsx(oC, { size: 14 }),
                      m.jsx("span", { children: rhCur ? rhCur.name || rhCur.workflowId : "未选择工作流" }),
                    ],
                  }),
                  m.jsx("button", {
                    type: "button",
              ...
              m.jsxs("div", {
                ...
                children: [
                  ...
                  m.jsxs("button", {
                    ...
                    title: "模型",
                    onClick: () => i("model"),
                    children: [m.jsx(vi, { size: 14 }), m.jsx("span", { children: u || "选择模型" })],
                  }),
                  m.jsxs("button", {
                    type: "button",
                  ...
                  m.jsxs("button", {
                    ...
                    title: "生成张数",
                    onClick: () => i("count"),
                    children: [m.jsx(eC, { size: 14 }), m.jsx("span", { children: `${t.count || 1}张` })],
                  }),
                  m.jsx("button", {
                    type: "button",
                    className: "compact-run",
                  ...
                  m.jsxs("label", {
                    ...
                    children: [
                      ...
                      m.jsx("select", {
                        ...
                        onMouseDown: Lt,
                        onChange: (s) => i("size", s.target.value),
                        children: ["3:4", "4:3", "9:16", "16:6"].map((s) =>
                          m.jsx("option", { value: s, children: s }, s),
                        ),
                      }),
                    ],
                  }),
  ...
  return m.jsxs("div", {
    ...
    children: [
      m.jsxs("div", {
        ...
        children: [
          m.jsx("span", { className: "image-preview-name", children: e.name || "图片预览" }),
          m.jsx("button", {
            type: "button",
